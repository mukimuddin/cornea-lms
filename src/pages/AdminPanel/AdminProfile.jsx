...
function AdminProfile() {
  const [profile, setProfile] = useState({
    ...
    achievements: 'Best Admin Award (2018)',
    additionalInfo: 'This is additional information about the Admin.',
    profilePicture: null,
  });
              ...
              <div key={key} className="flex flex-col">
                ...
                {isEditing ? (
                  <input
                    ...
                    className="mt-1 px-4 py-2 border border-red-500 rounded-lg bg-gray-100 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500"
                  />
                ) : (
                  <span className="mt-1 text-gray-700">{value}</span>
                )}
              </div>
            )
          ))}
